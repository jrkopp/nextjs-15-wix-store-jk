...
const formSchema = z.object({
  ...
  body: z
    ...
    .or(z.literal("")),
  rating: z.number().int().min(1, "Please rate this product between 1 to 5"),
});
...
function AttachmentPreview({
  ...
  return (
    ...
    >
      ...
      {state === "uploading" && (
        <div className="lef1-1/2 absolute right-1/2 -translate-x-1/2 -translate-y-1/2 transform">
          <Loader2 className="animate-spin" />
        </div>
      )}
      {state === "failed" && (
        <div
          className="lef1-1/2 absolute right-1/2 -translate-x-1/2 -translate-y-1/2 transform"
